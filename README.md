...
docker run -it --rm -p 8888:8888 -v $(pwd):/app:rw knowledge_compendium --jupyter

# For building the Jupyter book
docker run -it --rm -v $(pwd):/app:rw knowledge_compendium --build-compendium

# For building and serving the Jupyter book on http://127.0.0.1:8080
docker run -it --rm -p 8888:8888 -v $(pwd):/app:rw knowledge_compendium --serve-compendium
```
